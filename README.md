# GP77 Web Corporate Site

![GP77 Cover](public/logo.png) <!-- Reemplaza esto con una imagen representativa o elimina la línea si no tienes imagen de portada -->
...
- **[GSAP](https://greensock.com/gsap/)**: Para animaciones complejas y fluidas de alto rendimiento.
- **[Framer Motion](https://www.framer.com/motion/)**: Animaciones declarativas y transiciones de página en React.
...
- **Responsive Design:** Adaptabilidad completa para dispositivos móviles, tablets y escritorios.
...
1. **Clona el repositorio:**
   ```bash
   git clone https://github.com/santifuenma/gp77-web.git
   cd gp77-web
   ```
...
---
*Desarrollado con pasión por Santiago Fuenmayor.*
